    ...
    <div className='relative text-white text-[20px] w-full max-w-[1360px] mx-auto'>
        ...
        >
            <div >
                ...
                <div className='px-[15px] md:px-[40px] py-[10px] md:py-[25px] font-oswald bg-white absolute bottom-[25px] md:bottom-[75px] left-0 text-black/[0.9] text-[15px] md:text-[30px] uppercase font-medium cursor-pointer hover:opacity-90 hover:scale-110 duration-300'>
                    shop now
                </div>
            </div>
            <div >
